...
<template>
    <div class="min-h-screen w-full flex bg-[#0a0a0b] text-[#f2f2f3]" style="font-family: 'Geist', sans-serif;">
        ...
        <div class="w-full md:w-[420px] flex flex-col justify-center px-[24px] md:px-[48px] py-12 mx-auto md:mx-0 shrink-0">
            ...
            <!-- Heading -->
            <h1 class="text-[24px] font-[700] text-white leading-tight tracking-tight mb-2">Welcome back</h1>
            <p class="text-[14px] text-[#71717a] mb-[24px]">Sign in to continue to your dashboard</p>
            ...
            <form @submit.prevent="submit" class="flex flex-col gap-4">
                ...
                <div class="flex items-center justify-end w-full">
                    <Link href="#" class="text-[12px] text-[#71717a] hover:text-white transition-colors duration-200">Forgot password?</Link>
                </div>

                <div class="h-[24px]"></div>

                <!-- Submit -->
                <button type="submit" :disabled="form.processing" class="w-full h-[40px] bg-[#6366f1] hover:bg-[#5558e3] active:scale-[0.99] text-white text-[14px] font-[500] rounded-[7px] transition-all duration-120 flex items-center justify-center outline-none">
            ...
            <div class="mt-4 text-center">
                <span class="text-[13px] text-[#71717a]">Don't have an account? </span>
                <Link :href="route('register')" class="text-[13px] text-[#6366f1] hover:text-white transition-colors duration-200">Create one</Link>
            </div>
        </div>
